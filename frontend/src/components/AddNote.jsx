...
function AddNote({ isOpen, onCancel, darkMode }) {
  ...
  return (
    <>
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
            <div className={`w-full max-w-md rounded-lg p-6 ${darkMode ? "bg-[#252525] text-white" : "bg-white text-black"}`}>
                ...
                <div className="mt-5 flex flex-col-reverse gap-3 sm:mt-10 sm:flex-row sm:justify-between">
                    <button className={`w-full sm:w-auto bg-[#6C63FF]  px-2 py-1 rounded-sm cursor-pointer ${darkMode ? "bg-transparent text-[#6C63FF] border" : "bg-[#6C63FF] text-white"}`}
